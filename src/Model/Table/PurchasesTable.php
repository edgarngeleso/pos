...
class PurchasesTable extends Table
{
    ...
    public function initialize(array $config): void
    {
        ...
        $this->setDisplayField('purchaseID');
        $this->setPrimaryKey('purchaseID');
    }
    ...
    {
        $validator
            ->scalar('purchaseItems')
            ->maxLength('purchaseItems', 1000)
            ->requirePresence('purchaseItems', 'create')
            ->notEmptyString('purchaseItems');
